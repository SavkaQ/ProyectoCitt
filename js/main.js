...
(function(exports) {
    ...
    return {
      usuarios: [
        ...
        },
        {
          ...
          correo: 'daniela.rojas@duocuc.cl',
          rut: '15.345.678-5',
          rol: 'docente',
        ...
        },
        {
          ...
          correo: 'esteban.munoz@duocuc.cl',
          rut: '17.654.321-8',
          rol: 'ayudante',
          contrasena: 'Ayuda123',
        ...
        {
          id: 'dir-1',
          nombre: 'Francisca León',
          correo: 'francisca.leon@duocuc.cl',
          rut: '13.222.333-6',
          rol: 'director',
          contrasena: 'Director123',
          telefono: '+56 2 2655 0000',
          matricula: 'DIR001',
          matriculaActiva: true,
          notificaciones: true
        },
  ...
  function actualizarEstadoDeSesion() {
    ...
    enlacesProtegidos.forEach((enlace) => {
      const rolesPermitidos = enlace.dataset.requiere.split(',');
  ...
  function redirigirSegunRol(rol) {
    const base = window.location.pathname.includes('/views/') ? '../views/' : './views/';
    const destinos = {
      administrador: `${base}admin.html`,
      coordinador: `${base}coordinador.html`,
      director: `${base}director.html`,
      docente: `${base}configuracion.html`,
      ayudante: `${base}configuracion.html`,
      estudiante: `${base}configuracion.html`
    };

    window.location.href = destinos[rol] || `${base}home.html`;
  }
